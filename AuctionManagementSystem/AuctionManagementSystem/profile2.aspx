<%@ Page Title="" Language="C#" MasterPageFile="~/indexseller.Master" AutoEventWireup="true" CodeBehind="profile2.aspx.cs" Inherits="AuctionManagementSystem.profile2" %>
...
<body>
		...
		<table>
			...
			<tr><td>Re-Enter Password</td><td><asp:TextBox ID="txtrePass" runat="server" TextMode="Password" required></asp:TextBox></td></tr>
